...
| <a name="input_invocation_lambda_name"></a> [invocation\_lambda\_name](#input\_invocation\_lambda\_name) | The name of the frontend Lambda function | `string` | `"aws-permissions-bot-frontend"` | no |
